...
if (sys.nframe() == 0){
  ...
  if (!debugmode){
    ...
    rm(list=ls())
    opt = list(input_filename="~/s/g/korbel/hoeps/lab/assemblies/new_invextracts/chr1-26641304-INV-5445_backup/paf/chr1-26641304-INV-5445_HG00096_h1.paf",
