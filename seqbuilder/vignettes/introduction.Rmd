...
make_chunked_minimap_alnment(outfasta, outmutfasta, samplepaf_link, 
                             outplot=NULL, chunklen = 5000, minsdlen = 0, saveplot=F, 
...
mutate_seq(outfasta, sdfile_tsv, svfile_dupB, outmutfasta, outmutsd)
...
if (seqlen <= 25000){
  exact_plot = make_dotplot(outfasta, outmutfasta2, 15, save=F)
  print(exact_plot  + ggplot2::labs(title='Simulated Sequence #3. Double mutation: INV + DUP'))
}
```
